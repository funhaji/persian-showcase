      ...
      <div className="container pt-6 pb-20 space-y-12">
        ...
        <section className="bg-[#e91e63] rounded-[2.5rem] overflow-hidden p-6 md:p-10 flex flex-col md:flex-row gap-8 shadow-2xl relative">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {products
                ...
                .map((product) => (
                  <div
                    key={product.id}
                    className="bg-white rounded-3xl p-4 flex flex-col items-center group relative shadow-xl hover:-translate-y-2 transition-transform duration-300"
                  >
                    ...
                    <h4 className="text-[11px] font-bold text-zinc-800 line-clamp-2 text-center mb-2 h-8">
                      {product.name}
                    </h4>
                    <div className="mt-auto flex flex-col items-center">
                      <p className="text-[#e91e63] text-sm font-black">
          ...
          <div className="md:w-60 flex flex-col items-center justify-center text-white text-center space-y-6 z-10">
            ...
            <Link to="/products">
              <Button
                variant="outline"
                className="bg-white/10 border-white/40 text-white hover:bg-white hover:text-[#e91e63] rounded-full px-8 py-6 text-sm font-bold backdrop-blur-sm transition-all duration-300 shadow-lg"
              >
                مشاهده محصولات
              </Button>
            </Link>
        ...
        <section className="relative rounded-[2.5rem] overflow-hidden h-64 md:h-80 border-none group shadow-2xl">
          ...
          <div className="relative z-20 h-full flex flex-col justify-center p-10 md:p-16 text-white max-w-xl space-y-4">
            <span className="bg-[#ffeb3b] text-black text-[11px] font-black px-4 py-1 rounded-full w-fit shadow-lg uppercase tracking-widest">
              ٪۳۰ تخفیف ویژه
            </span>
            <h3 className="text-4xl md:text-5xl font-black leading-tight tracking-tighter">
              پرطرفدارهای برقی اینجاست!
            </h3>
            <p className="text-white/70 text-sm md:text-base font-medium max-w-sm">
              بهترین ابزارهای زیبایی و مراقبت از پوست با قیمت استثنایی
            </p>
            <Link to="/products" className="pt-2">
              <Button
                size="lg"
                className="bg-white text-black hover:bg-[#e91e63] hover:text-white rounded-full font-black px-10 shadow-xl transition-all duration-300"
              >
                مشاهده و خرید
              </Button>
            </Link>
        ...
        <section className="pt-8">
          <div className="flex items-center justify-between mb-10 border-b border-muted pb-6">
            ...
            <Link to="/products">
              <Button
                variant="ghost"
                className="text-sm font-bold text-zinc-500 hover:text-[#e91e63] hover:bg-[#e91e63]/5 rounded-full px-6 transition-all"
              >
                مشاهده همه محصولات
